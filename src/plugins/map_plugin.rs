...
use crate::{systems::{mouse_click::mouse_click, tile_clicked_spawn::tile_clicked_spawn, tile_clicked_animation::tile_clicked_animation}, 
...
impl Plugin for MapPlugin {
    fn build(&self, app: &mut App) {
        app.insert_resource(CursorState { spawn_done: false, click_pos: None})
